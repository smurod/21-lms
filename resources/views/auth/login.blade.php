...
<div class="auth-card">
    ...
    <section class="auth-panel">
        ...
        <form class="auth-form active" id="loginForm" novalidate>
            @csrf
            <h2>Welcome to School 21</h2>
            <p class="auth-sub">Please enter your email and password that you received earlier</p>

            <div class="auth-error" id="loginError">{{ session('error') ? e(session('error')) : '' }}</div>
            ...
            <div class="field">
                ...
                <button class="eye-btn" type="button" data-eye="loginPassword" aria-label="Show password">
            ...
            <div class="auth-actions">
                ...
                <a class="forgot" href="{{ route('forgot-password') }}">Forgot your password?</a>
            </div>

            <div class="auth-divider"></div>

            <div class="auth-hint">
                <h3>How to begin the study?</h3>
                <p>If you want to study at the next-gen School, press the <a href="{{ route('register') }}">link to School21</a></p>
            </div>
        </form>
